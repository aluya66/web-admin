<template>
  <c-card :name="title" class="form-card" id="form-other">
    ...
    <el-form-item label="创建时间:" v-if="isView || isDisabled">{{formModel.created}}</el-form-item>
    <el-form-item label="更新时间:" v-if="isView || isDisabled">{{formModel.updated}}</el-form-item>
