<template>
  <c-card :name="title" class="form-card" id="form-base">
    ...
    <el-form-item label="活动类型:" prop="businessValue">
      <el-select
        v-if="!isView"
        class="select-item"
        :disabled="isDisabled"
    ...
    <el-form-item label="使用渠道:" prop="businessValue">
      <el-select
        v-if="!isView"
        class="select-item"
        :disabled="isDisabled"
    ...
    <el-form-item label="活动时间类型:" prop="businessValue">
      <el-select
        v-if="!isView"
        class="select-item"
        :disabled="isDisabled"
    ...
    <el-form-item label="设置固定周期:" prop="created">
      <el-date-picker
        disabled
    ...
    <el-form-item label="设置固定月份:" prop="businessValue">
      <el-select
        v-if="!isView"
        class="select-item"
        :disabled="isDisabled"
    ...
    <el-form-item label="设置固定日期:" prop="businessValue">
      <el-select
        v-if="!isView"
        class="select-item"
        :disabled="isDisabled"
