  ...
  <c-view>
    ...
    <Card>
      <div class="select-bar">
        ...
        <el-cascader :options="regionList" clearable filterable v-model="optionsMessage"></el-cascader>
  ...
  methods: {
    ...
    queryAllParentcodes() {
      ...
      this.$api.basic.queryAllParentcodes(params).then(data => {
        ...
        that.regionList = JSON.parse(dataList.replace(/code/g, 'value').replace(/name/g, 'label'))
